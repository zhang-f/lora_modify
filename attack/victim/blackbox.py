...
class Blackbox(object):
    ...
    def from_modeldir(cls, model_dir, device=None, output_type='probs'):
        ...
        print("=> loading checkpoint '{}'".format(osp.realpath(checkpoint_path)))
        # print('real path:', osp.realpath(checkpoint_path))
        # print('checkpoint keys:', torch.load(checkpoint_path).keys())
