...
from knockoff.adversary.weight_pruner import weight_prune
...
def main():
    ...
    input_shape = datasets.modelfamily_to_shape[modelfamily]
    ...
    for b in budgets:
        ...
        for ratio in [0.2]:
            ...
            # args.lr = args.remain_lr + (args.update_lr-args.remain_lr) * ratio
            # print(args.lr)

            graybox_dir = params['victim_model_dir']
            ...
            pretrained = zoo.get_net(model_name, modelfamily, params['pretrained'], num_classes=num_classes)
            ...
            # checkpoint_suffix = '.{}.{}'.format(b, args.graybox_mode)
            ...
            ckpt_name = f"checkpoint.{args.graybox_mode}.{ratio}.{b}.pth.tar"
            ...
            json_name = f"stealing_eval.{args.graybox_mode}.{ratio}.{b}.json"
